<template>
    <div>
        <instruction-modal :show="instructionFirst" prev-button-text="" next-button-text="Next"
            @next-button-action="instructionFirst = false; instructionSecond = true;" title="Measure your body"
            image="../../assets/images/instructions/instruction-measure.png" content="Now with your phone camera we will
        ...
        <instruction-modal :show="instructionSecond" prev-button-text="Back" next-button-text="Next"
            ...
            @prev-button-action="instructionSecond = false; instructionFirst = true;" title="Fit in camera frame"
        ...
        <instruction-modal :show="instructionThird" prev-button-text="Postpone it" next-button-text="Measure me"
            @next-button-action="instructionThird = false;" @prev-button-action="skipMeasure()"
            title="Your safety comes first" image="../../assets/images/instructions/instruction-woman-2.png" content="The most important thing is your safety, 
