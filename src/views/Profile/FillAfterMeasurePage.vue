<template>
    <bikefitter-page title="Measures" :without-title="true" :without-tab-bar="true" :background-color="'secondary'">
        <!--
            TODO: dodaj walidacje zeby mogl nacisnac ok jak beda te pomiary
        -->
        <div>
            <div class="pt-3">
                <h1 class="fitter-h1">
            ...
            <ion-button expand="block" color="light" @click="saveChangesAndGoHome" class="mt-6">
                Ok
            </ion-button>
...
const saveChangesAndGoHome = async () => {
    await user.value?.save();
