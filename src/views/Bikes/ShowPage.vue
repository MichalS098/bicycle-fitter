<template>
    <ion-page>
        <div class="h-screen w-screen bg-black relative">
            ...
            <div class="px-3 py-4 rounded-t-[30px] bg-neutral-800 absolute bottom-0 left-0 right-0 w-full flex flex-col gap-6 transition-all duration-500 ease-in-out"
                @touchstart="touchStart" @touchmove="touchMove" @touchend="touchEnd"
                :class="{ 'h-1/4': !isExpanded, 'h-3/4': isExpanded }">
                <div class="mx-auto w-[40px] h-[5px] rounded-full bg-neutral-700"></div>
